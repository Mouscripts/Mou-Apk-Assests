this_server_domain = "https://weecima.store/";
    ...
    "cats":
    {
        "الافلام":
        {
            ...
            "cats":
            {
                "افلام عربية": {
                    "type": "list",
                    "url": this_server_domain + "category/افلام/6-arabic-movies-افلام-عربي/",
                    "icon": `<i class="fas fa-film"></i>`
                },
                "افلام اجنبية": {
                    "type": "list",
                    "url": this_server_domain + "category/افلام/10-movies-english-افلام-اجنبي/",
                    "icon": `<i class="fas fa-film"></i>`
                },
                "افلام تركية": {
                    "type": "list",
                    "url": this_server_domain + "category/افلام/افلام-تركى-turkish-films/",
                    "icon": `<i class="fas fa-film"></i>`
                },
                "افلام هندية": {
                    "type": "list",
                    "url": this_server_domain + "category/افلام/افلام-هندي-indian-movies/",
                    "icon": `<i class="fas fa-film"></i>`
                },
                "افلام كرتون": {
                    "type": "list",
                    "url": this_server_domain + "category/افلام-كرتون/",
                    "icon": `<i class="fas fa-film"></i>`
                }
            }
        ...
        "المسلسلات":
        {
            ...
            "cats":
            {
                "مسلسلات عربية": {
                    "type": "list",
                    "url": this_server_domain + "category/مسلسلات/13-مسلسلات-عربيه-arabic-series/list/",
                    "icon": `<i class="fas fa-tv"></i>`
                },
                "مسلسلات أجنبية": {
                    "type": "list",
                    "url": this_server_domain + "category/مسلسلات/5-series-english-مسلسلات-اجنبي/list/",
                    "icon": `<i class="fas fa-tv"></i>`
                },
                "مسلسلات تركية": {
                    "type": "list",
                    "url": this_server_domain + "category/مسلسلات/8-مسلسلات-تركية-turkish-series/list/",
                    "icon": `<i class="fas fa-tv"></i>`
                },
                "مسلسلات كرتون": {
                    "type": "list",
                    "url": this_server_domain + "category/مسلسلات-كرتون/",
                    "icon": `<i class="fas fa-tv"></i>`
                }
            }
        }
...
mou_aflam_servers_array["سيرفر 1"] = obj;